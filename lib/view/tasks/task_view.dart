...
import '../home/theme_notifier.dart';
import '../home/widgets/category_selector.dart';
import '../home/widgets/priority_selector.dart';
        ...
        children: [
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                CategorySelector(
                  selectedCategoryId: _selectedCategoryId ?? widget.task?.categoryId,
          ...
          Padding(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('Priority', style: textTheme.headlineSmall),
                const SizedBox(height: 8),
                PrioritySelector(
                  initialPriority: widget.task?.priority ?? 3,
